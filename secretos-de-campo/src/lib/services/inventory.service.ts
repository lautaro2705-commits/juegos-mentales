...
export async function calculateEstimatedStock(
  ...
  // TODO: Decisión de negocio — estrategia de redondeo.
  // ────────────────────────────────────────────────────────────────────
  // Cuando los porcentajes se multiplican por el peso y se redondean,
  // puede haber una diferencia de ±0.01 a ±0.10 kg entre la suma de
  // cortes y el peso total real.
  //
  // Opciones:
  // A) Absorber en el corte más grande (asado) → simple, predecible
  // B) Distribuir proporcionalmente entre todos los cortes
  // C) Dejar como está y mostrar la varianza al usuario
  //
  // Implementar adjustVariance() aquí si se elige A o B.
  // Actualmente se usa la opción C (varianza visible).
  // ────────────────────────────────────────────────────────────────────
